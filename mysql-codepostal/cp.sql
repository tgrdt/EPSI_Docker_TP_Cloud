...
CREATE TABLE utilisateurs (
	...
	ut_login varchar(100) NOT NULL,
	ut_motdepasse varchar(128) NOT NULL,
	ut_salt varchar(100) NOT NULL,
	CONSTRAINT utilisateurs_PK PRIMARY KEY (ut_id),
	CONSTRAINT utilisateurs_UN UNIQUE KEY (ut_login)
)
ENGINE=InnoDB
...
(ut_login, ut_motdepasse, ut_salt)
VALUES('admin', SHA2(CONCAT('bjncoj165165ncac','password'),256), 'bjncoj165165ncac');
